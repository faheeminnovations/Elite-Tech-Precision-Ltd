<x-app-layout>
    ...
    <div class="card">
        <div class="title">New Service Job</div>
        <div class="sub">Record a new service visit, repair, or maintenance job</div>
            ...
            <div class="wizard-step-content active" data-step="1">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" name="address" rows="2" placeholder="Full service location address">{{ old('address') }}</textarea>
                    </div>
                </div>
            ...
            <div class="wizard-step-content" data-step="2">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="job_ref" value="{{ old('job_ref') }}" placeholder="e.g. SV-1001">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="site_installation" value="{{ old('site_installation') }}" placeholder="e.g. Unit 4, Northgate">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" name="next_ppm_due" value="{{ old('next_ppm_due') }}">
                    </div>
                </div>
            ...
            <div class="wizard-step-content" data-step="4">
                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <textarea class="form-control" name="job_details" rows="3" placeholder="Description of work to be performed">{{ old('job_details') }}</textarea>
                    </div>
                    <div class="col-12">
                        <label class="form-label">Work Completed</label>
                        <textarea class="form-control" name="work_completed" rows="3" placeholder="Summary of work that was actually completed">{{ old('work_completed') }}</textarea>
                    </div>
                    <div class="col-12">
                        <label class="form-label">Job Notes</label>
                        <textarea class="form-control" name="job_notes" rows="2" placeholder="Engineer notes and observations">{{ old('job_notes') }}</textarea>
                    </div>
                    <div class="col-12">
                        <label class="form-label">Recommendations / Remedial Works</label>
                        <textarea class="form-control" name="recommendations" rows="3" placeholder="Any recommendations for follow-up work or maintenance">{{ old('recommendations') }}</textarea>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" name="remedial_details" rows="2" placeholder="Details of remedial works required">{{ old('remedial_details') }}</textarea>
                    </div>
                </div>
                
                <div class="btn-row">
                    <button type="button" class="btn btn-ef-secondary" onclick="prevStep(4)">Previous</button>
                    <button type="submit" class="btn btn-ef-primary">Save Service</button>
                </div>
            </div>
        </form>
    </div>
