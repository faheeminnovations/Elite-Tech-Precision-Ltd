...
<div class="card ef p-3">
  <div class="section-head">
    <div>
      ...
      <div class="section-sub">Record a new service visit, repair, or maintenance job</div>
    </div>
  </div>
  <div class="card-body" style="padding:0;">
  <form action="{{ route('services.store') }}" method="POST" data-form-type="service">
    @csrf
    <div class="row g-3" style="padding-top:16px;">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('job_ref') is-invalid @enderror" id="job_ref" name="job_ref" value="{{ old('job_ref') }}" required placeholder="e.g. SV-1001">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('service_type') is-invalid @enderror" id="service_type" name="service_type" required>
                                ...
                                <option value="PPM" {{ old('service_type') === 'PPM' ? 'selected' : '' }}>PPM</option>
                                ...
                                <option value="Service Call" {{ old('service_type') === 'Service Call' ? 'selected' : '' }}>Service Call</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <select class="form-select @error('engineer_id') is-invalid @enderror" id="engineer_id" name="engineer_id">
                                    ...
                                    @foreach($engineers as $engineer)
                                        <option value="{{ $engineer->id }}" data-name="{{ $engineer->name }}" {{ old('engineer_id') == $engineer->id ? 'selected' : '' }}>
                                            {{ $engineer->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <input type="hidden" id="engineer_name" name="engineer_name" value="{{ old('engineer_name') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('site_installation') is-invalid @enderror" id="site_installation" name="site_installation" value="{{ old('site_installation') }}" placeholder="e.g. Unit 4, Northgate">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control @error('next_ppm_due') is-invalid @enderror" id="next_ppm_due" name="next_ppm_due" value="{{ old('next_ppm_due') }}">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" rows="2" placeholder="Full service location address">{{ old('address') }}</textarea>
                            @error('address')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="col-12">
                            <label for="job_details" class="form-label fw-bold">Job Details</label>
                            <textarea class="form-control @error('job_details') is-invalid @enderror" id="job_details" name="job_details" rows="3" placeholder="Description of work to be performed">{{ old('job_details') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('work_completed') is-invalid @enderror" id="work_completed" name="work_completed" rows="3" placeholder="Summary of work that was actually completed">{{ old('work_completed') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('job_notes') is-invalid @enderror" id="job_notes" name="job_notes" rows="2" placeholder="Engineer notes and observations">{{ old('job_notes') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('recommendations') is-invalid @enderror" id="recommendations" name="recommendations" rows="3" placeholder="Any recommendations for follow-up work or maintenance">{{ old('recommendations') }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('remedial_required') is-invalid @enderror" id="remedial_required" name="remedial_required">
                                ...
                                <option value="no" {{ old('remedial_required') === 'no' ? 'selected' : '' }}>No</option>
                                <option value="yes" {{ old('remedial_required') === 'yes' ? 'selected' : '' }}>Yes</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control @error('remedial_details') is-invalid @enderror" id="remedial_details" name="remedial_details" rows="2" placeholder="Details of remedial works required">{{ old('remedial_details') }}</textarea>
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:18px;padding-top:12px;border-top:1px solid var(--line);">
      <button type="submit" class="btn-ef-primary" style="padding:8px 16px;border-radius:8px;border:none;color:#1a1300;font-weight:600;font-size:13px;cursor:pointer;"><i class="bi bi-save me-1"></i>Save Service</button>
