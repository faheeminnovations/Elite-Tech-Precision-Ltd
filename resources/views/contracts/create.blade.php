            ...
            <div class="wizard-step-content active" data-step="1">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <x-area-select name="area" :value="old('area')" label="" />
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" name="customer_contact" value="{{ old('customer_contact') }}">
                    </div>
                </div>
            ...
            <div class="wizard-step-content" data-step="2">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="contract_ref" value="{{ old('contract_ref') }}">
                    </div>
                    <div class="col-md-6">
            ...
            <div class="wizard-step-content" data-step="3">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" name="job_ref" value="{{ old('job_ref') }}">
                    </div>
                </div>
